            ...
            <TextField
              ...
              helperText={
                isShowAll
                  ...
                  : selectedDate
                  ? `📅 Har oyda ${dayjs(selectedDate).format("DD")}-sanada to'lovi bo'lgan qarzdorlar`
                  : "💡 Har oyda muayyan kunda to'lovi bo'lgan qarzdorlarni ko'rish uchun istalgan sanani tanlang"
              }
              FormHelperTextProps={{
                sx: { 
                  fontSize: "0.75rem",
