...
const CustomerItemImproved: React.FC<CustomerListItemProps> = memo(({
  customer,
  onClick,
  showDebtBadge = false,
}) => {
...
CustomerItemImproved.displayName = 'CustomerItemImproved';

export default CustomerItemImproved;